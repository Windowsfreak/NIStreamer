 ...
 */
public class OniFileSource implements Source, OpenNIHelper.DeviceOpenListener {
    ...
    public OniFileSource(SettingsActivity activity) {
    ...
    public void initialize(final Config config) {
        ...
        //devicePending = true;
        //helper.requestDeviceOpen(config.sourceUrl, this);
