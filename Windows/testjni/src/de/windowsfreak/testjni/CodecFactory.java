...
public abstract class CodecFactory {
    ...
    static {
        ...
        cf.add(new CodecFactory("Snappy") {
            @Override
            public AbstractCodec getCodec(Config config) {
                SnappyCodec codec =  new SnappyCodec(config.x, config.y);
                codec.toggleDebug(config.debug);
                return codec;
            }
            @Override
            public AbstractCodec getCodec() {
    ...
    public AbstractCodec getCodec(Config config) {
        return getCodec(config.x, config.y);
    }
}
