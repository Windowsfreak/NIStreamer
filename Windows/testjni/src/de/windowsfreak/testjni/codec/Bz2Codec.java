...
public class Bz2Codec extends AbstractCodec {
    private int level = 0;
    public Bz2Codec() {}
    public Bz2Codec(final int x, final int y) {
        super(x, y);
    }
    public Bz2Codec(final int compressionLevel) { level = compressionLevel; }
    public Bz2Codec(final int x, final int y, int compressionLevel) {
        super(x, y);
